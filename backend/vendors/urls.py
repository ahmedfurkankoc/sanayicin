...
from .views import VendorProfileView, VendorRegisterView, SetVendorPasswordView, VendorSearchView, VendorDetailView, AppointmentViewSet, CustomerAppointmentView
