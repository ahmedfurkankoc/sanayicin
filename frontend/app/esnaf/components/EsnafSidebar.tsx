    ...
    <>
      <div className="esnaf-sidebar">
        ...
        <nav className="esnaf-nav">
          <a href="/esnaf/panel" className={`esnaf-nav-item ${activePage === "panel" ? "active" : ""}`}>
            <Icon name="clipboard" className="esnaf-nav-icon" color="white" />
            <span className="esnaf-nav-text">Özet</span>
            {activePage === "panel" && <span className="esnaf-nav-dot"></span>}
          </a>
          <a href="/esnaf/takvim" className={`esnaf-nav-item ${activePage === "takvim" ? "active" : ""}`}>
          ...
          <a href="/esnaf/randevularim" className={`esnaf-nav-item ${activePage === "randevularim" ? "active" : ""}`}>
          ...
          <a href="/esnaf/profil" className={`esnaf-nav-item ${activePage === "profil" ? "active" : ""}`}>
      ...
      <nav className="esnaf-mobile-nav">
        <a href="/esnaf/panel" className={`esnaf-mobile-nav-item ${activePage === "panel" ? "active" : ""}`}>
        ...
        <a href="#" className="esnaf-mobile-nav-item">
          <span className="esnaf-mobile-nav-icon">
        ...
        <a href="/esnaf/ayarlar" className={`esnaf-mobile-nav-item ${activePage === "ayarlar" ? "active" : ""}`}>
          <span className="esnaf-mobile-nav-icon">
